        ...
        this.tabList = [
            {
                link:"/userInfo",
                name:"个人信息",
                uncheck_icon:"../src/img/user_tab_box_user_info_uncheck.png",
                check_icon:"../src/img/user_tab_box_user_info_check.png",
                activity:true
            },
            {
                link:"/accountManage",
                name:"账户管理",
                uncheck_icon:"../src/img/user_tab_box_account_uncheck.png",
                check_icon:"../src/img/user_tab_box_account_check.png",
                activity:false,
            },
            {
                link:"/orderList",
                name:"我的订单",
                uncheck_icon:"../src/img/user_tab_box_order_uncheck.png",
                check_icon:"../src/img/user_tab_box_order_check.png",
                activity:false,
            },
            {
                link:"/voucherList",
                name:"优惠券",
                uncheck_icon:"../src/img/user_tab_box_voucher_uncheck.png",
                check_icon:"../src/img/user_tab_box_voucher_check.png",
                activity:false,
            }
        ];
        this.state = {
        ...
        return (
            <div className="user_tab_box">
                <div className="user_tab_box_user_info">
                    ...
                    <div className="user_tab_box_user_name">{this.props.userInfo.nickName}</div>
                </div>
